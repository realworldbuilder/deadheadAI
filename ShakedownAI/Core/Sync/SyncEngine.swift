...
/// Keeps the phone's shelves in step with the notesfile: push what changed
/// here, pull what changed there, last writer wins by `updatedAt`, deletes
/// travel as tombstones. One cycle at a time. Only shelves — the journal and
/// mix tapes stay on the phone.
@Observable
